...
<head>
<meta charset="UTF-8">
<title>팝니다 오일류 | 슈퍼마켙!</title>
<%@ include file="../include/header.jsp" %>
<script>
function list(page){
	location.href="${path}/shop/goods/list3.do?curPage="+page+"&keyword=${map.keyword}";
} 
</script>
</head>
<body>
...
<section class="section-margin calc-60px">
      <div class="container">
        <div class="section-intro pb-60px">
          ...
          <h2>Oil & <span class="section-intro__style">Vinegar</span></h2>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              <div class="card-product__img">
                <img class="card-img" src="${path}/img/goods/oil/${row.img_path}">
     ...
     <form name="form1" method="post" action="${path}/shop/goods/list3.do" style="text-align: center;">
