...
<article>
		<div class="container" role="main" style="padding:10px;">
			<div class="info__img">
				<img src="${path}/img/공지사항.png" 
				style="display:block; margin:0px auto; margin-top:30px; width:200px; height:55px;">
			</div><br>
			<div class="bg-white rounded shadow-sm" style="padding:20px;">
				<div class="board_title" style="font-size:28px;">
				...
				<div class="board_content" style="height:300px;">${boardContent.content}</div><hr>
