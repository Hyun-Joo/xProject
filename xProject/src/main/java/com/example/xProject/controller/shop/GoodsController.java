...
public class GoodsController {
	...
	@RequestMapping("list.do") //제1카테고리(치즈)에 속하는 상품 목록 조회
	...
	@RequestMapping("list2.do") //제2카테고리(소스·향신료)에 속하는 상품 목록 조회
	...
	@RequestMapping("list3.do") //제3카테고리(오일·식초)에 속하는 상품 목록 조회
	...
	@RequestMapping("detail/{good_id}") //개별 상품 정보 조회
	...
	@RequestMapping("write.do") //상품 등록 페이지로 이동(관리자만 가능)
	public String write() {
		return "shop/goods_write";
	}
	@RequestMapping("insert.do") //상품 등록
	...
	@RequestMapping("edit/{good_id}") //상품 정보 수정 페이지로 이동(관리자만 가능)
	...
	@RequestMapping("update.do") //상품 정보 수정
	...
	@RequestMapping("delete.do") //상품 정보 삭제
	...
	@RequestMapping("sale") //할인 상품 목록으로 이동
