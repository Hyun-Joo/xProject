...
public class UserController {
	...
	@RequestMapping("signup.do") //회원가입 페이지로 이동
	public String signup() {
		return "user/join";
	}
	
	@ResponseBody
	@RequestMapping(value="/idCheck", method=RequestMethod.POST) //아이디 중복확인
	...
	@RequestMapping("join.do") //회원가입 완료
	...
	@RequestMapping("login.do") //로그인 페이지로 이동
	public String login() {
		return "user/login";
	}
		
	  @RequestMapping("login_check.do") //로그인 성공/실패 여부 판단
	  ...
	  @RequestMapping("list.do") //관리자 전용 회원관리 페이지로 이동
	  ...
	  @RequestMapping("view.do") //마이페이지로 이동
	  ...
	  @RequestMapping("update.do") //마이페이지에서 개인정보 수정
